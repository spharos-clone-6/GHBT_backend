...
public enum ErrorCode {
    ...
    NOT_FOUND_ORDER_ERROR("요청 하신 주문 내역은 존재하지 않습니다.", NOT_FOUND, 404),
    ...
    FAIL_TO_SAVE_ORDER_LIST("결제 완료 과정 중 서버에서 문제가 발생하였습니다.", INTERNAL_SERVER_ERROR, 500),
    FAIL_TO_PAYMENT_CANCEL("결제 완료 과정 중 서버에서 문제가 발생하였습니다.", INTERNAL_SERVER_ERROR, 500),
    //배송지
